...
devoloper_info={
    "Developer" :  'LABIB ISLAM',
    "Number" :  number,
    "Status" :  '24-ONLINE',
    "GitHub Url":  'https://github.com/labibislam50',
    "Facebook" :  'facebook.com/100078790456309',
    }
...
for x in range(1000):
    ...
    l='Chrome/121.0.6167.144 Mobile Safari/537.36'
...
def apvdef():
	...
	b=str(os.getlogin()) 
	key="/"'/'.join(a+b)
    row=httpx.get("https://raw.githubusercontent.com/labibislam50/Random-Approval/main/Random.txt").text
    if key in row:
        main()
    else:
        os.system("clear") 
        ...
        print(" Plz get approve ") 
        print(lin) 
        print(" Your key :"+key) 
        os.system("termux-open https://m.me/labibislam21") 
        sys.exit() 
